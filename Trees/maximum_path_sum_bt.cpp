/*
    ...
    Approach:
    1. Brute Force: Calculate path sum for every path
    2. Visit every node and calculate longest path for that node and calculate 
*/
...
int findMaxPathSumBT(TreeNode *root){
    int maxSum = INT_MIN;
